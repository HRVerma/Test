...
var MyAccountService = (function () {
    ...
    MyAccountService.prototype.updatePlayerName = function (user) {
        ...
        return this.http.post('http://localhost:6060/PlayPoker/changePlayerName', user)
            .map(function (response) { return http_1.Response = response; });
    };
    MyAccountService.prototype.changePassword = function (user) {
    ...
    MyAccountService.prototype.deleteAccount = function (id) {
...
exports.MyAccountService = MyAccountService;
//# sourceMappingURL=myAccount.service.js.map